package cn.edu.gdmec.w07150837.thread;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void anr(View v) {
        for (int i = 0; i < 100000; i++) {
            BitmapFactory.decodeResource(getResources(), R.drawable.myimg);
        }
    }
    ...
    public void handlermessage(View v) {
        final Handler myHandler = new Handler() {
            ...
            public void handleMessage(Message msg) {
                ...
                switch (msg.what) {
                    case 1:
                        showmsg(String.valueOf(msg.arg1 + msg.getData()
                                .get("attach").toString()));
                }
            }
        };
        class MyTask extends TimerTask {
            int countdown;
            double achievement1 = 1;
            double achievement2 = 2;
        ...
        class LearHard extends AsyncTask<Long, String, String> {
            ...
            protected String doInBackground(Long... longs) {
                ...
                while (count < duration) {
                    num--;
                    count++;
                    String status = "离毕业还有" + num + "秒,努力学习" + count
                            + "秒.";
